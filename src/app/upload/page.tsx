...
export default function UploadPage() {
  ...
  const renderExifData = () => {
    if (!appContext.exifData) {
      return (
        <pre>
          <code>Extracting metadata...</code>
        </pre>
      );
    }
    ...
    const formattedEntries = Object.entries(appContext.exifData).map(
      ([key, value]) => {
              ...
              <div className="file-info-section">
                <div className="file-info-row">
                  ...
                  <div className="file-info-text-content">
                    <span className="file-info-main-text">{fileInfo.name}</span>
                ...
                <div className="file-info-row">
                  ...
                  <div className="file-info-text-content">
                    <span className="file-info-main-text">{fileInfo.type}</span>
                    <span className="file-info-label-text">
                      Image File Type
                    </span>
                  </div>
                </div>
